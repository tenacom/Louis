...
/// <summary>
/// Represents an argument to check, whose type is a non-nullable reference type.
/// </summary>
/// <typeparam name="T">The type of the argument.</typeparam>
[StackTraceHidden]
public readonly ref struct Arg<T>
    where T : class
{
    ...
    /// <summary>
    /// <para>Gets the argument represented by the current <see cref="Arg{T}"/> object.</para>
    /// </summary>
    public T Value { get; }
...
#pragma warning restore CA2225 // Operator overloads have named alternates
    ...
    /// <summary>
    /// Checks that the argument represented by the current <see cref="Arg{T}"/> object
    ...
    /// </param>
    /// <returns>The current <see cref="Arg{T}"/> object.</returns>
    ...
    public Arg<T> Check(Predicate<T> predicate, string? message = null)
    ...
    public Arg<T> Check(ArgumentCheckFunc<T> func)
